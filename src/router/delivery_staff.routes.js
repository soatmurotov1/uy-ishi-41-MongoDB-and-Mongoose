...
deliRouter.post("/", roleGuard("admin", "manager"), validation(delivery_straffValidation), registerUser)
deliRouter.get("/profile", authGuard, roleGuard("customer","admin","manager"), profileUser);
deliRouter.get("/", authGuard, roleGuard("admin", "manager", "staff"), getAllUsers)
deliRouter.put("/:id", authGuard, roleGuard("admin", "manager"), validation(delivery_staffUpdValidation), updateUser)
deliRouter.delete("/:id", authGuard, roleGuard("admin"), deleteUser)
